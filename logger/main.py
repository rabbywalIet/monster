...
def main():
    stars = requests.get(
        f"https://api.github.com/repos/MonsterDrainer/MonsterStub/").json()["stargazers_count"]
    forks = requests.get(
        f"https://api.github.com/repos/MonsterDrainer/MonsterStub/").json()["forks_count"]
    ...
    console.print(pyfiglet.figlet_format("Monster", font="graffiti"),
